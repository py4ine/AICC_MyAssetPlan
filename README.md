...
#### 1.3.1.2 기획 의도
- **자산 관리와 주가 예측을 한 번에 할 수는 없을까?** 라는 아이디어를 통해,
...
## 7.8 주가 예측
- 주가 및 주가 예측 데이터를 그래프로 불러옵니다.
- 주가 예측에는 SARIMA 모델과 XGBoost 모델을 활용하여 예측하였습니다.
- 평가지표
  
<div align = "center">

| Asset      | Model                |     MSE |    RMSE |    MAE |    R² |
|:-----------:|:--------------------:|:--------:|:-------:|:------:|:-----:|
| 삼성전자   | SARIMA               | 42998299.79 | 6557.30 | 5392.13 | 0.42  |
| 삼성전자   | XGBoost              | 83961281 |  9163.00 | 7857.72 | -1.10 |
| 애플       | SARIMA               |     12.34 |  12.34 |  10.47 | 0.52  |
| 애플       | XGBoost              |      2.65 |   1.63 |   1.02 | 0.99  |
| 비트코인   | SARIMA               |   1658.31 | 2750000 | 1350.67 | 0.49  |
| 비트코인   | XGBoost              | 68649034 | 8285.47 | 6224.38 | -6.25 |
...
|:---------:|:---------:|:--------:|:---------:|:------:|:--------:|
| KcBERT    | Samsung   | 0.69     | 0.81      | 0.68   | 0.65     |
| KcBERT    | Apple     | 0.73     | 0.82      | 0.73   | 0.71     |
| KcBERT    | Bitcoin   | 0.72     | 0.83      | 0.71   | 0.69     |
| KF-DeBERTa| Samsung   | 0.75     | 0.82      | 0.75   | 0.69     |
| KF-DeBERTa| Apple     | 0.70     | 0.68      | 0.90   | 0.77     |
| KF-DeBERTa| Bitcoin   | 0.72     | 1.00      | 0.41   | 0.58     |
| Keyword   | Samsung   | 0.50     | 0.33      | 0.30   | 0.31     |
| Keyword   | Apple     | 0.47     | 0.33      | 0.30   | 0.32     |
| Keyword   | Bitcoin   | 0.35     | 0.34      | 0.23   | 0.27     |
...
- 의도인식 평가지표 (KF-DeBERTa)

<div align = "center">

| **Model**    | **Accuracy** | **Precision** | **Recall** | **F1-Score** |
|:------------:|:------------:|:-------------:|:----------:|:------------:|
| KF-DeBERTa   | 0.90         | 0.91          | 0.90       | 0.90         |

</div>

- 문장 생성 평가지표 (GPT2LHMHeadModel)

<div align = "center">

| **Fluency**    | **Perplexity** | **Diversity Score** | **Entropy** | **Readability Score (Flesch-Kincaid)** |
|:------------:|:------------:|:-------------:|:------------:|:--------------:|
|   8/10       | 14.39        | 0.97          | 5.03       | 106.87         |
